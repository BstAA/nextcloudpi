...
?>
  ...
  <header role="banner"><div id="header">
    <div id="header-left">
      ...
      <a id=versionlink target="_blank" href="https://github.com/BstAA/nextcloudpi/blob/master/changelog.md">
        <?php
          $version  = "v0.0.0";
    ...
    <div id="header-right">
      ...
      <a href="https://github.com/BstAA/nextcloudpi/wiki" target="_blank" tabindex="1"  title="<?php echo $l->__("NextCloudPi Wiki"); ?>">
        <div id="nc-button">
            <div class="expand">
